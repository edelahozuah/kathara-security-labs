...
- Topología, rutas y paquetes: `NETWORK.md`
- Casos prácticos de ataque MITM: `EXAMPLES.md`
- Imágenes Docker y personalización: `DOCKER.md`
...
- Quiero validar WireGuard y VNC: `README.md` y `QUICKSTART.md`
- Quiero ejemplos de ataques MITM: `EXAMPLES.md`
- Quiero cambiar paquetes/imágenes: `DOCKER.md`
...
- Topology, routes, and packet paths: `NETWORK.md`
- Practical MITM attack examples: `EXAMPLES.md`
- Docker images and customization: `DOCKER.md`
...
- I need WireGuard and VNC checks: `README.md` and `QUICKSTART.md`
- I need MITM attack examples: `EXAMPLES.md`
- I need to modify images/packages: `DOCKER.md`
