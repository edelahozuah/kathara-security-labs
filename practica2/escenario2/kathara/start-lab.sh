...
Opciones:
  --cli-only              Arranca solo victima/atacante/router/natgw
...
echo "== Inicio escenario Kathara p2_2 (cross-platform) =="
...
if [[ ${CLI_ONLY} -eq 1 ]]; then
  ...
  start_nodes victima atacante router natgw

  echo ""
  echo "=== Escenario listo (modo CLI-only) ==="
  echo "Nodos activos: victima atacante router natgw"
  echo "Sin WireGuard ni VNC en este modo."
  echo ""
...
start_nodes victima atacante router natgw vpn desktop
